...
export default class Paragraph {
    ...
    drawView() {
        ...
        div.classList.add(this._CSS.wrapper, this._CSS.block, this._CSS.alignment[this.data.alignment], 'font');

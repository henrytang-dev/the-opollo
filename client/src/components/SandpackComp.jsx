    ...
    <SandpackLayout>
      ...
      <div style={{width: '49.9%'}}>
          <div className='flex h-10'>
            <FileTabs closableTabs={true} style={{
              width: '90%'
            }}/>
          ...
          <SandpackCodeViewer closableTabs showRunButton showLineNumbers showTabs={false}
          style={{
